...
class PlatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plate" do
    assert_difference('Plate.count') do
      post plates_url, params: { plate: { cooktime: @plate.cooktime, description: @plate.description, price: @plate.price } }
    end
  ...
  test "should update plate" do
    patch plate_url(@plate), params: { plate: { cooktime: @plate.cooktime, description: @plate.description, price: @plate.price } }
